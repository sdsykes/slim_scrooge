...
SlimScrooge is similar to (and is partly derived from) "Scrooge":http://github.com/methodmissing/scrooge but has many fewer lines of code and is faster. Note also that SlimScrooge only works with Mysql, whereas Scrooge works with any DB.
